...
public class MailService {
	...
	public void sendEmail(@Valid @RequestBody MailMessage message) throws MailException {
		...
		mail.setFrom("carhopcontact@gmail.com");
		mail.setTo(message.getEmailAddress());
		mail.setSubject(message.getSubject());
		mail.setText(message.getBodyText());
		/*
